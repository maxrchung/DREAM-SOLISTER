...
int main() {
		...
		MusicSheet("voice.MusicSheet", 90, imageWidth, Color(0, 169, 195), "lyric.MusicSheet");
		MusicSheet("wind.MusicSheet", -10, imageWidth, Color(247, 255, 8), "");
		MusicSheet("drum.MusicSheet", -110, imageWidth, Color(255, 209, 219), "");
