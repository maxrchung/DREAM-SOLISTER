...
Vector2 Vector2::Project(Vector2 axis) const {
...
Vector2 Vector2::Rotate(float rotation) const {
...
Vector2 Vector2::operator*(float multiple) const {
...
Vector2 Vector2::operator/(float division) const {
